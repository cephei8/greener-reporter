...
#cgo linux LDFLAGS: -L../zig-out/lib  -lgreener_reporter -lgreener_servermock -Wl,-rpath,../zig-out/lib
#cgo darwin LDFLAGS: -L../zig-out/lib  -lgreener_reporter -lgreener_servermock -Wl,-rpath,../zig-out/lib
#cgo windows LDFLAGS: -L../zig-out/lib  -lgreener_reporter -lgreener_servermock
