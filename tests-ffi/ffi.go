...
#cgo linux LDFLAGS: -L../zig-out/lib -L../target/release -lgreener_reporter -lgreener_servermock -Wl,-rpath,../target/release -Wl,-rpath,../zig-out/lib
#cgo darwin LDFLAGS: -L../zig-out/lib -L../target/release -lgreener_reporter -lgreener_servermock -Wl,-rpath,../target/release -Wl,-rpath,../zig-out/lib
#cgo windows LDFLAGS: -L../zig-out/lib -L../target/release -lgreener_reporter -lgreener_servermock
...
func GetFixtureNames() ([]string, error) {
	...
	errC := (*C.greener_servermock_error_t)(nil)
	var namesc **C.char
...
func (a *GreenerReporter) Delete() *GreenerReporterError {
	errC := (*C.greener_reporter_error_t)(nil)
...
type GreenerReporterSession struct {
	h *C.greener_reporter_session_t
}
